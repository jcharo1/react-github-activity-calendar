...
exports.createInitialWeeks = exports.DayName = void 0;
exports.getAllContributionsByYear = getAllContributionsByYear;
exports.getColor = getColor;
exports.getContributionsForYear = getContributionsForYear;
exports.months = exports.getStyleOptions = void 0;
...
function requestOptions(githubUserName, token) {
...
const getStyleOptions = (weekIndex, props) => {
  if (weekIndex <= 5) {
    return {
...
function getAllContributionsByYear(githubUserName, token) {
...
function getContributionsForYear(githubUserName, year, token) {
  const graphql = JSON.stringify({
    query: "query ($userName: String!, $from: DateTime!, $to: DateTime!) {\n" + "  user(login: $userName) {\n" + "    contributionsCollection(from: $from, to: $to) {\n" + "      startedAt\n" + "      totalCommitContributions\n" + "      totalPullRequestContributions\n" + "      totalIssueContributions\n" + "      totalPullRequestReviewContributions\n" + "      totalRepositoriesWithContributedCommits\n" + "      totalRepositoriesWithContributedPullRequests\n" + "      totalRepositoriesWithContributedIssues\n" + "      totalRepositoriesWithContributedPullRequestReviews\n" + "      totalRepositoryContributions\n" + "      contributionCalendar {\n" + "        totalContributions\n" + "        weeks {\n" + "          contributionDays {\n" + "            contributionCount\n" + "            date\n" + "          }\n" + "        }\n" + "      }\n" + "    }\n" + "  }\n" + "}",
    variables: {
      userName: githubUserName,
      from: "".concat(year, "-01-01T00:00:00Z"),
      // Start of the year
      to: "".concat(year, "-12-31T23:59:59Z") // End of the year
    }
  });
  ...
  return fetch("https://api.github.com/graphql", {
    ...
    console.error("Error fetching contributions for ".concat(year, ":"), error);
  });
}
...
exports.createInitialWeeks = createInitialWeeks;